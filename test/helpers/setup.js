...
module.exports = async () => {
    ...
    const createOrder = async (signer, fromToken, toToken, amountIn, amountOutMin, deadline, fee, overrides = {}) => {        
        ...
        const order = new Order(signer, fromToken, toToken, amountIn, amountOutMin, signer.address, deadline, fee);
